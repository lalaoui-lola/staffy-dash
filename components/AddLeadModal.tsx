...
export default function AddLeadModal({ onClose, onLeadAdded, agentId, agentName }: AddLeadModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl max-w-5xl w-full my-8 animate-slideUp max-h-[90vh] overflow-y-auto border border-white/20">
        ...
        <div className="bg-gradient-to-r from-[#175C64] to-[#0E3A40] p-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center text-white">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm mt-1 font-medium">Agent: {agentName}</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Building2 className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="text"
                  name="nom_societe"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Calendar className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="date"
                  name="date_rdv"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Clock className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="time"
                  name="heure_rdv"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FileText className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="text"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <MapPin className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="text"
                  name="departement"
            ...
            <div className="group md:col-span-2">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Hash className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <input
                  type="text"
                  name="numero_siret"
            ...
            <div className="group md:col-span-2">
              ...
              <div className="relative">
                <div className="absolute top-3 left-3 pointer-events-none">
                  <MessageSquare className="h-5 w-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                </div>
                <textarea
                  name="commentaire"
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none"
                  placeholder="Notes, observations, détails supplémentaires..."
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-[#175C64] to-[#0E3A40] text-white font-semibold rounded-lg hover:from-[#0E3A40] hover:to-[#175C64] disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 shadow-lg"
            >
              {loading ? (
