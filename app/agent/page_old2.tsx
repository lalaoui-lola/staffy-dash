      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 animate-fadeIn">
          ...
          <p className="text-gray-600">
            {leads.length} rendez-vous au total
          </p>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-primary-50 border border-blue-200 rounded-2xl p-6 animate-fadeIn" style={{ animationDelay: '500ms' }}>
          ...
          <ul className="space-y-2 text-sm text-blue-800">
            <li className="flex items-start">
              ...
              <span>Préparez vos rendez-vous en amont avec toutes les informations nécessaires</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
            ...
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
              <span>Vérifiez régulièrement le statut de validation qualité</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-600 mr-2">✓</span>
              <span>Maintenez vos coordonnées clients à jour</span>
            </li>
          </ul>
        </div>
      </main>
